...
function LeftSidebar() {
  ...
  // MODULE 2 DROPDOWN REVEAl
  const mod2Expand = () => {
    document.querySelectorAll(".module2-drop").forEach(item => {
      item.classList.toggle("active");
    })

    // Rotating the dropdown arrow
    document.querySelectorAll(".xcmo99").forEach(item => {
      item.classList.toggle("roshash0");
    })
  };
  ...
  return (
    <>
      ...
      <section
        id="sidebar-exp"
        className="scrollabr max-w-[248px] hidden lg:inline-flex side-expanded side12  overflow-auto top-[72px] gap-40 py-6 px-3 justify-between h-[calc(100vh_-_72px)] bg-white z-[5] flex-col fixed"
      >
        {/* TOP OF NAVBAR */}
        <section className="top-nav inline-flex flex-col gap-3">
            ...
            <section className="flex flex-col gap-1">
              ...
              <section className="inline-flex flex-col gap-2">
                ...
                <section className="module-cont w-max overflow-hidden inline-flex flex-col cmo">
                  ...
                  <article>
                    {/*  TOP */}
                    <article className="module-item flex gap-20 items-center py-3 pl-10 pr-4 justify-between rounded-[4px] text-[#1D2739] font-semibold">
                      <h5 className="text-[14px] leading-[145%]">Module 02</h5>
                      <div
                        onClick={() => mod2Expand()}
                        className="shrink-0 rotate-[180deg] rotate-effect xcmo99"
                      >
                        <Image src={down2} alt="dropdown" />
                      </div>
                    </article>
                    ...
                    {/* DROPDOWN */}
                    <article className="module2-drop">
                      <nav className="inline-flex flex-col text-[14px] text-[#475467] leading-[145%] py-2 gap-2">
                        {/* ACTIVE */}
                        <Link
                          className="pl-[48px] pr-4 py-2 block  text-[#1D2739] bg-[#F0F2F5] font-semibold rounded-[4px]"
                          href="#"
                        >
                          <p className="max-w-[162px]">Credibility Statement</p>
                        </Link>
                        <Link className="pl-[48px] pr-4 py-2 block " href="#">
                          <p className="max-w-[162px]">Big 3 & Offer Basics</p>
                        </Link>
                        <Link className="pl-[48px] pr-4 py-2 block " href="#">
                          <p className="max-w-[162px]">
                            Product Guarantee Generator
                          </p>
                        </Link>
                        <Link className="pl-[48px] pr-4 py-2 block " href="#">
                          <p className="max-w-[162px]">
                            Product Bonus Generator
                          </p>
                        </Link>
                      </nav>
                    </article>
          ...
          <section className="inline-flex flex-col gap-2">
            ...
            <section className="module-cont overflow-hidden inline-flex flex-col gap-1 py-2 cmo">
              ...
              <article>
                ...
                {/* DROPDOWN */}
                <article className="module2-drop">
                  <nav className="flex flex-col text-[14px] text-[#475467] leading-[145%] py-2 gap-2">
                    {/* ACTIVE */}
                    <Link
                      className="pl-[32px] pr-4 py-3 block  text-[#1D2739] bg-[#F0F2F5] font-semibold rounded-[4px]"
                      href="#"
                    >
                      <p className="">Credibility Statement</p>
                    </Link>
                    <Link className="pl-[32px] pr-4 py-3 block " href="#">
                      <p className="">Big 3 & Offer Basics</p>
                    </Link>
                    <Link className="pl-[32px] pr-4 py-3 block " href="#">
                      <p className="">
                        Product Guarantee Generator
                    ...
                    <Link className="pl-[32px] pr-4 py-3 block " href="#">
                      <p className="">Product Bonus Generator</p>
                    </Link>
                  </nav>
                </article>
              </article>
